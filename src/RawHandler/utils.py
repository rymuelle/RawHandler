...
def align_images(rh1, rh2, dims, 
                 offset=(0, 0, 0, 0), max_iters=100,
                 step_sizes = [16, 8, 4, 2]):
    ...
    for step_size in step_sizes:
        directions = [np.array((step_size, step_size, 0, 0)),
        ...
        for _ in range(max_iters):
            ...
            for step_dir in directions:
                ...
                if not check_if_crop_is_valid(img_shape, crop_edges): continue
